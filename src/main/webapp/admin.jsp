...
<body class="bg-gray-100">
    ...
    <section id="login" class="flex items-center justify-center min-h-screen">
            <div class="bg-white p-6 rounded-lg shadow-lg w-96">
                ...
                <form action="AdminCheck" method="post" class="space-y-4">
                    <input type="email" name="emailAdmin" placeholder="Email" class="w-full p-2 border rounded">
                    <input type="password" name="passwordAdmin" placeholder="Mot de passe" class="w-full p-2 border rounded">
